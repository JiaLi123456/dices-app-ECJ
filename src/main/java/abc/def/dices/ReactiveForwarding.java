...
public class ReactiveForwarding {
    ...
    public void activate(ComponentContext context) {
        ...
        ////////////////////////////////////////////////////////////////////////
        log.info("set a lot of things for dynamic adaptive control task");
...
//            for (Path i : paths){
//                System.out.println("Let`s print the set of paths according to getPaths"+i.toString());
//                log.info("Let`s print the set of paths according to getPaths"+i.toString());
//
//            }
...
//            String receiveId="of:0000000000000005";
            ...
            //////////////////////////////////////////////////////////////////
//            ///////////////////////////////////////////////////////////////////
//            if ((sendId.contains(pkt.receivedFrom().deviceId().toString()))&&(dst.location().deviceId().toString().equals(receiveId))) {
//                System.out.println("///////////////////////////////////////////");
//                System.out.println("print the path from " + pkt.receivedFrom().deviceId() + " to " + dst.location().deviceId());
//                for (Link l1 : linkService.getLinks()) {
//                    try {
//                        if (path.links().contains(l1)) {
//
//                            System.out.println(l1.src() + " : " + l1.dst() + " : " + ((TempLinkWeight) linkWeighter).getLinkWeight(l1));
//                        } else {
//                            System.out.println("other links::" + l1.src() + " : " + l1.dst() + " : " + ((TempLinkWeight) linkWeighter).getLinkWeight(l1));
//                        }
//                    } catch (Exception e) {
//                        if (path.links().contains(l1)) {
//
//                            System.out.println(l1.src() + " : " + l1.dst() + " : " + ((DynamicLinkWeight) linkWeighter).getLinkWeight(l1));
//                        } else {
//                            System.out.println("other links::" + l1.src() + " : " + l1.dst() + " : " + ((DynamicLinkWeight) linkWeighter).getLinkWeight(l1));
//                        }
//
//                    }
//
